...
`generate_sha(file_path: &String) -> ()` | Performs a SHA1 hash on the given file and displays the digest | `generate_sha("The quick brown fox jumps over the lazy dog")` |  `"2fd4e1c..."`
`generate_md5(file_path: &String) -> ()` | Performs a MD5 hash on the given file and displays the digest | `generate_md5("The quick brown fox jumps over the lazy dog")` | `"9e107d9..."`